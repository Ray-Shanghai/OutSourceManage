 ...
 * 
 */ 
public class SysFunctionInfoPower extends BaseInfo{ 
	/**
	 * 
	 */
	private static final long serialVersionUID = 6840952976933276697L;
	//主键 
	...
	public String toString() {
		return "SysFunctionInfoPower [funcitonId=" + funcitonId
				...
				+ ", functionUrl=" + functionUrl + ", functionStyle="
				+ functionStyle + ", functionSeque=" + functionSeque
