/** layui-v1.0.5(All Modules) LGPL-2.1 license By http://www.layui.com */
;
...
function(i) {
    ...
    y = {
        ...
        clickThis: function() {
            ...
            a = i.parents(o),
            n = a.attr("lay-filter");
            i.find("." + d)[0] || (i.addClass(l).siblings().removeClass(l), layui.event.call(this, e, "nav(" + n + ")", i))
        },
        clickChild: function() {
            var i = t(this),
            a = i.parents(o),
            n = a.attr("lay-filter");
            i.addClass(l).siblings().removeClass(l),
    ...
    p.on("click", v, y.tabClick),
    p.on("click", y.hideTabMore),
