...
layui.config({
	...
	clientAutoRefresh =true;
		...
		tab = layui.tab({
			...
			autoRefresh:true	,
			clientAutoRefresh:clientAutoRefresh,
			contextMenu:true,
			scrollbar:true
	...
	navbar.set({
		...
		url:base.serverContent+"/manager/loginIn/SysUserInfo/getCurrentUserMenuByMenuId.do?menuId=all"
		/*cached:true,
		url: 'datas/nav.json'*/
	});
	//渲染navbar
